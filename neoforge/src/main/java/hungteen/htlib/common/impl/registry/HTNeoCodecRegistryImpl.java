 ...
 */
public class HTNeoCodecRegistryImpl<V> extends HTCodecRegistryImpl<V> implements HTCodecRegistry<V> {
     ...
     */
    public HTNeoCodecRegistryImpl(ResourceLocation registryName, Supplier<Codec<V>> codecSup, @Nullable Supplier<Codec<V>> syncSup, @Nullable Class<V> registryClass, boolean requireCache) {
