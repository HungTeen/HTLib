...
const config = {
  ...
  organizationName: 'HungTeen', // Usually your GitHub org/user name.
  projectName: 'HTLib', // Usually your repo name.
  trailingSlash: false,
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/HungTeen/HTLib/tree/master/website',
        },
        blog: {
