...
public interface WorldHelper {
     ...
     */
    static BlockPos getSuitableHeightRandomPos(Level world, BlockPos pos, int minR, int maxR) {
    ...
    static BlockPos getSuitableHeightRandomPos(Level world, BlockPos pos, int maxR) {
        return getSuitableHeightRandomPos(world, pos, 0, maxR);
    }

    static BlockPos getSuitableHeightPos(Level world, BlockPos pos) {
        int y = world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, pos.getX(), pos.getZ());
        return new BlockPos(pos.getX(), y, pos.getZ());
    }

    static int getSurfaceHeight(Level world, double x, double z) {
