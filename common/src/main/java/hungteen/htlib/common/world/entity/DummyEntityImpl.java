 ...
 **/
public abstract class DummyEntityImpl implements HTDummyEntity {
    ...
    public DummyEntityImpl(DummyEntityType<?> entityType, ServerLevel level, Vec3 position) {
    ...
    public DummyEntityImpl(DummyEntityType<?> entityType, Level level, CompoundTag tag){
        this.entityType = entityType;
        this.level = level;
