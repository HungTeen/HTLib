 ...
 **/
public class RaidResultDefenderEventJS extends EntityEventJS {

    private final RaidEvent.RaidResultDefenderEvent event;

    public RaidResultDefenderEventJS(RaidEvent.RaidResultDefenderEvent event) {
        this.event = event;
    }
