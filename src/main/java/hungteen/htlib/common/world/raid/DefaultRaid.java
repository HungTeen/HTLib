...
public class DefaultRaid extends AbstractRaid {
    ...
    public DefaultRaid(ServerLevel serverLevel, Vec3 position, ResourceKey<IRaidComponent> raidKey) {
        super(HTDummyEntities.DEFAULT_RAID, serverLevel, position, raidKey);
    }
